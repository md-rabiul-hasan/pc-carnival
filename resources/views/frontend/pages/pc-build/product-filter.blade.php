                    ...
                    <div class="col-12">
                        ...
                        <div class="product-menu">
                            <div class="product-title">
                                <h3 class="title-group-3 g1nt-1">Choose Component For Your Dream Build</h3>
                            </div>
                        </div>
                                                ...
                                                <div class="single-product row">
                                                    ...
                                                    <div class="col-lg-9 col-md-8 col-12">
                                                        <div class="product-description">
                                                            ...
                                                            <p class="description">{!! $product->key_features !!}</p>
                                                        </div>

                                                        <div class="product-button add-pc-build">
                                                            <button onclick="addToPcBuild({{ $product->id }})">Add</button>
                                                            <div class="price-box">
...
function addToPcBuild(id){
    // Get the query string from the URL
    const queryString = window.location.search;

    // Parse the query string to extract parameter values
    const urlParams = new URLSearchParams(queryString);

    // Get the value of the 'component' parameter
    const component = urlParams.get('component');
        
    axios.post('{{ route("add-to-pc-build") }}', {
            product_id: id,
