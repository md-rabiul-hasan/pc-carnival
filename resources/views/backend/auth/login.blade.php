      ...
      <div class="login-box">
        <form class="login-form"  action="{{route('adminLoginPost')}}" method="post">
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="text" name="email" value="mdrabiulhasan.me@gmail.com" required placeholder="Email" autofocus>
          </div>
          <div class="form-group">
            <label class="control-label">PASSWORD</label>
            <input class="form-control" type="password" name="password" value="password" required placeholder="Password">
          </div>
