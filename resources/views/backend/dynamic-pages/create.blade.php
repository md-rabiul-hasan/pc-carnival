...
@endsection
@section('content')
<form action="{{ route('admin.dynamic-page.store') }}" method="POST" enctype="multipart/form-data">
   <div class="row">
      @csrf
      <div class="col-md-12">
         <div class="tile">
            ...
            <div class="tile-body">
               <div class="form-group">
                  ...
                  <textarea class="form-control" id="editor1"  rows="3" name="about_us"></textarea>
               </div>            
            </div>
         </div>
      </div> 
         ...
         <div class="tile">
            ...
            <div class="tile-body">
               <div class="form-group">
                  ...
                  <textarea class="form-control" id="editor2"  rows="3" name="privacy_policy"></textarea>
               </div>            
            </div>
         </div>
      </div>  
         ...
         <div class="tile">
            ...
            <div class="tile-body">
               <div class="form-group">
                  ...
                  <textarea class="form-control" id="editor3"  rows="3" name="terms_and_condition"></textarea>
               </div>            
            </div>
         </div>
      </div> 
         ...
         <div class="tile">
            ...
            <div class="tile-body">
               <div class="form-group">
                  ...
                  <textarea class="form-control" id="editor4"  rows="3" name="delivery_option"></textarea>
               </div>            
            </div>
         </div>
      </div>   
