...
<div class="app-title">
   <div>
      <h1><i class="fa fa-bell-o"></i> Edit PC Build Mapping</h1>
      <p>Edit PC Build Sub Category Mapping</p>
   </div>
   <ul class="app-breadcrumb breadcrumb">
      <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
      <li class="breadcrumb-item"><a href="#">Edit PC Build Mapping</a></li>
   </ul>
</div>
@endsection
@section('content')
<form action="{{ route('admin.pc-build.update') }}" method="POST" enctype="multipart/form-data">
   <div class="row">
      @csrf
      <div class="col-md-6">
         <div class="tile">
            <h3 class="tile-title">Update Mapping PC Build Core Components</h3>
            <div class="tile-body">
                <div class="form-group">
                    ...
                    <select class="form-control select2" name="processor" id="processor" required>
                       ...
                       @foreach($sub_categories as $sub_category)
                        <option value="{{ $sub_category->id }}" @if($sub_category->id == $pc_builds['processor']) {{ "selected" }} @endif >{{ $sub_category->title }}</option>
                       @endforeach
                    </select>
                 </div> 
                 <div class="form-group">
                    ...
                    <select class="form-control select2" name="motherboard" id="motherboard" required>
                       ...
                       @foreach($sub_categories as $sub_category)
                        <option value="{{ $sub_category->id }}" @if($sub_category->id == $pc_builds['motherboard']) {{ "selected" }} @endif >{{ $sub_category->title }}</option>
                       @endforeach
                    </select>
                 </div>    
                 <div class="form-group">
                    ...
                    <select class="form-control select2" name="graphics_card" id="graphics_card" required>
                       ...
                       @foreach($sub_categories as $sub_category)
                        <option value="{{ $sub_category->id }}" @if($sub_category->id == $pc_builds['graphics_card']) {{ "selected" }} @endif >{{ $sub_category->title }}</option>
                       @endforeach
                    </select>
                 </div>
                 <div class="form-group">
                    ...
                    <select class="form-control select2" name="cpu_cooler" id="cpu_cooler" required>
                       ...
                       @foreach($sub_categories as $sub_category)
                        <option value="{{ $sub_category->id }}" @if($sub_category->id == $pc_builds['cpu_cooler']) {{ "selected" }} @endif >{{ $sub_category->title }}</option>
                       @endforeach
                    </select>
                 </div>
                 <div class="form-group">
                    ...
                    <select class="form-control select2" name="ram_1" id="ram_1" required>
                       ...
                       @foreach($sub_categories as $sub_category)
                        <option value="{{ $sub_category->id }}" @if($sub_category->id == $pc_builds['ram_1']) {{ "selected" }} @endif >{{ $sub_category->title }}</option>
                       @endforeach
                    </select>
                 </div>
                 ...
                 <div class="form-group">
                    ...
                    <select class="form-control select2" name="ram_2" id="ram_2" required>
                       ...
                       @foreach($sub_categories as $sub_category)
                        <option value="{{ $sub_category->id }}" @if($sub_category->id == $pc_builds['ram_2']) {{ "selected" }} @endif >{{ $sub_category->title }}</option>
                       @endforeach
                    </select>
                 </div>
                 ...
                 <div class="form-group">
                    ...
                    <select class="form-control select2" name="storage" id="storage" required>
                       ...
                       @foreach($sub_categories as $sub_category)
                        <option value="{{ $sub_category->id }}" @if($sub_category->id == $pc_builds['storage']) {{ "selected" }} @endif >{{ $sub_category->title }}</option>
                       @endforeach
                    </select>
                 </div>
                 ...
                 <div class="form-group">
                    ...
                    <select class="form-control select2" name="power_supply" id="power_supply" required>
                       ...
                       @foreach($sub_categories as $sub_category)
                        <option value="{{ $sub_category->id }}" @if($sub_category->id == $pc_builds['power_supply']) {{ "selected" }} @endif >{{ $sub_category->title }}</option>
                       @endforeach
                    </select>
                 </div>
                 ...
                 <div class="form-group">
                    ...
                    <select class="form-control select2" name="casing" id="casing" required>
                       ...
                       @foreach($sub_categories as $sub_category)
                            <option value="{{ $sub_category->id }}" @if($sub_category->id == $pc_builds['casing']) {{ "selected" }} @endif >{{ $sub_category->title }}</option>
                       @endforeach
                    </select>
                 </div>
      ...
      <div class="col-md-6">
        <div class="tile">
           <h3 class="tile-title">Update Peripherals & Others</h3>
           <div class="tile-body">
               <div class="form-group">
                   ...
                   <select class="form-control select2" name="monitor" id="monitor" required>
                      ...
                      @foreach($sub_categories as $sub_category)
                       <option value="{{ $sub_category->id }}" @if($sub_category->id == $pc_builds['monitor']) {{ "selected" }} @endif >{{ $sub_category->title }}</option>
                      @endforeach
                   </select>
                </div> 
                <div class="form-group">
                   ...
                   <select class="form-control select2" name="case_fan" id="case_fan" required>
                      ...
                      @foreach($sub_categories as $sub_category)
                       <option value="{{ $sub_category->id }}" @if($sub_category->id == $pc_builds['case_fan']) {{ "selected" }} @endif >{{ $sub_category->title }}</option>
                      @endforeach
                   </select>
                </div>    
                <div class="form-group">
                   ...
                   <select class="form-control select2" name="ups" id="ups" required>
                      ...
                      @foreach($sub_categories as $sub_category)
                       <option value="{{ $sub_category->id }}" @if($sub_category->id == $pc_builds['ups']) {{ "selected" }} @endif >{{ $sub_category->title }}</option>
                      @endforeach
                   </select>
                </div>
                <div class="form-group">
                   ...
                   <select class="form-control select2" name="anti_virus" id="anti_virus" required>
                      ...
                      @foreach($sub_categories as $sub_category)
                       <option value="{{ $sub_category->id }}" @if($sub_category->id == $pc_builds['anti_virus']) {{ "selected" }} @endif >{{ $sub_category->title }}</option>
                      @endforeach
                   </select>
                </div>
                <div class="form-group">
                   ...
                   <select class="form-control select2" name="mouse" id="mouse" required>
                      ...
                      @foreach($sub_categories as $sub_category)
                       <option value="{{ $sub_category->id }}" @if($sub_category->id == $pc_builds['mouse']) {{ "selected" }} @endif >{{ $sub_category->title }}</option>
                      @endforeach
                   </select>
                </div>
                ...
                <div class="form-group">
                   ...
                   <select class="form-control select2" name="keyboard" id="keyboard" required>
                      ...
                      @foreach($sub_categories as $sub_category)
                       <option value="{{ $sub_category->id }}" @if($sub_category->id == $pc_builds['keyboard']) {{ "selected" }} @endif >{{ $sub_category->title }}</option>
                      @endforeach
                   </select>
                </div>
                ...
                <div class="form-group">
                   ...
                   <select class="form-control select2" name="headphone" id="headphone" required>
                      ...
                      @foreach($sub_categories as $sub_category)
                       <option value="{{ $sub_category->id }}" @if($sub_category->id == $pc_builds['headphone']) {{ "selected" }} @endif >{{ $sub_category->title }}</option>
                      @endforeach
                   </select>
                </div>
